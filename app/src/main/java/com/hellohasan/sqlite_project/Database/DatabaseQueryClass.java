...
public class DatabaseQueryClass {
            ...
            if(cursor!=null)
                if(cursor.moveToFirst()){
                    ...
                    do {
                        ...
                        String registrationNumber = cursor.getString(cursor.getColumnIndex(Config.COLUMN_STUDENT_REGISTRATION));
    ...
    public Student getStudentByRegNum(String registrationNum){
    ...
    public long deleteStudentByRegNum(String registrationNum) {
