...
public class StudentListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder> {
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        holder.registrationNumTextView.setText(student.getRegistrationNumber());
    ...
    private void deleteStudent(int position) {
        ...
        if(count>0){
            ...
            Toast.makeText(context, "Suppression  effectuée", Toast.LENGTH_LONG).show();
        } else
            Toast.makeText(context, "Suppression non effectuée!", Toast.LENGTH_LONG).show();
